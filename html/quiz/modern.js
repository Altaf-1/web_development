...
let questions = [{
    question: "<h4>A. Which among the following changes in the army was/were introduced by the British administration after the 1857 mutiny ? </h4><p><br>1. Increased proportion of Europeans to Indians in the army.<br>2. Introduction of idea of 'martial'and 'nonmartial'classes. <br>3. Increased recruitment from Awadh and Bihar. <br>Select the correct answer using the code given below:</p> ",
    choiceW: "1 only",
    ...
    question: "<h4>D. Consider the following statements: </h4><p><br> 1. ‘The Bengal Gazette’, started by James Augustus Hickey in 1780, was the first newspaper in vernacular language in India. <br> 2. Bal Gangadhar Tilak became the first Indian journalist to be imprisoned for his fight for the freedom of press.<br>Which of the statements given above is/are correct?</p>",
    choiceW: "1 only",
    choiceX: "2 only",
    choiceY: "1 and 2",
    choiceZ: "None of the above",
