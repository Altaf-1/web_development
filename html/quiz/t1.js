...
let questions = [{
    ...
    question: "<h4>D. Which of the following statements is/are correct regarding Salmonella bacteria?<br> 1. It is found in the intestines of humans, animals as well as birds.<br>2. It is a gram-positive bacterium.<br>3. Person-to-person transmission of the bacteria can occur through the fecal-oral route. <br> Which of the statements given above is/are correct ? </p>",
    choiceW: "1 only",
    choiceX: "2 only",
    choiceY: "1 and 3",
    choiceZ: "1,2 and 3",
