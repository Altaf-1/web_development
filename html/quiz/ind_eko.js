...
let questions = [{
    question: "<h4>A. Consider the following statements with respect to ‘self-employment’: </h4><p><br>1. These are the jobs where the renumeration is directly dependent upon the profits derived from the goods and services produced. <br> 2. In India, about 60% of self-employed are engaged in agriculture. <br> Select the correct answer using the code given below: </p> ",
    choiceW: "1 only",
    ...
    question: "<h4>B. Globalization is the process of rapid economic integration of countries. With regard to that, consider the factors that have enabled globalization: < /h4><p><br>1. Rapid improvement in technology. <br>2. The liberalization of foreign trade. <br>3. Imposing barrier on foreign investment.<br>4. Emergence of the World Trade Organization.<br>Select the correct answer using the code given below:</p> ",
    choiceW: "1,2 and 4",
    choiceX: "2 only",
    choiceY: "1,2 and 3",
    choiceZ: "2 and 3",
    ...
    question: "<h4>C. Consider the following statements regarding Self Help Groups (SHG):</h4><p><br>1. Though both men and women participate equally in SHGs, around 90 per cent of SHGs consist exclusively of women in India. <br> 2. SHGs are generally registered under the Companies Act, 2013 <br> 3. MGNREGA was targeted to increase the formation of SHGs in order to rejuvenate rural India. <br> Which of the statements given above is/are correct ? </p>",
    choiceW: "1 only",
    choiceX: "2 only",
    choiceY: "2 & 3",
